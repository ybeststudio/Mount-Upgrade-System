...
#endif
#if defined(ENABLE_PASSIVE_SYSTEM)
	PyModule_AddIntConstant(poModule, "AFFECT_PASSIVE_RELIC_STONE_DEF", CInstanceBase::NEW_AFFECT_PASSIVE_RELIC_STONE_DEF);
	PyModule_AddIntConstant(poModule, "AFFECT_PASSIVE_RELIC_DISMOUNT_SPEED", CInstanceBase::NEW_AFFECT_PASSIVE_RELIC_DISMOUNT_SPEED);
#endif
#if defined(ENABLE_AUTO_SYSTEM)
