...
public:
	CMainPacketHeaderMap()
	{
		...
		Set(HEADER_GC_NPC_LOCATION_HELPER, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCNPCLocationHelper), STATIC_SIZE_PACKET));
#endif
		...
		Set(HEADER_GC_TREASURE_HUNT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCTreasureHuntUIInfo), DYNAMIC_SIZE_PACKET));
#endif
